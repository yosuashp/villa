...
@endpush
@push('style-lib')
    <link rel="stylesheet" href="{{asset('assets/laramin/css/codemirror.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/laramin/css/monokai.min.css')}}">
@endpush
@push('script-lib')
    <script src="{{asset('assets/laramin/js/codemirror.min.js')}}"></script>
    <script src="{{asset('assets/laramin/js/css.min.js')}}"></script>
    <script src="{{asset('assets/laramin/js/sublime.min.js')}}"></script>
@endpush
@push('script')
<script>
    "use strict";
