                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('User')">
                                    <span class="font-weight-bold">{{ @$withdraw->owner->fullname }}</span>
                                    <br>
                                    {{-- <span class="small"> <a href="{{ route('admin.owners.detail', $withdraw->user_id) }}"><span>@</span>{{ $withdraw->user->username }}</a> </span> --}}
                                </td>
...
@push('breadcrumb-plugins')
    ...
    @if(!request()->routeIs('admin.owners.withdrawals') && !request()->routeIs('admin.owners.withdrawals.method'))
