                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($login_logs as $log)
                                ...
                                <td data-label="@lang('User')">
                                    ...
                                    <br>
                                    <span class="small"> <a href="{{ route('admin.owners.detail', $log->owner_id) }}"><span>@</span>{{ @$log->owner->username }}</a> </span>
                                </td>
                                    ...
                                    <td data-label="@lang('IP')">
                                        ...
                                        <a href="{{route('admin.report.owner.login.ipHistory',[$log->user_ip])}}">{{ $log->user_ip }}</a>
                                        </span>
                                    </td>
...
@push('breadcrumb-plugins')
    ...
    <form action="{{ route('admin.report.owner.login.history') }}" method="GET" class="form-inline float-sm-right bg--white">
    ...
    @endif
@endpush
@if(request()->routeIs('admin.report.owner.login.ipHistory'))
    @push('breadcrumb-plugins')
