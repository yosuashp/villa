                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="@lang('User')">
                                    ...
                                    @else 
                                    <span class="small">@lang('N/A')</span>
                                    @endif
                                </td>

                                <td data-label="@lang('Owner')">
                                    @if ($trx->owner_id)
                                    <span class="font-weight-bold">{{ $trx->owner->fullname }}</span>
                                    <br>
                                    <span class="small"> <a href="{{ route('admin.owners.detail', $trx->owner_id) }}"><span>@</span>{{ $trx->owner->username }}</a> </span>
                                    @else 
                                    <span class="small">@lang('N/A')</span>
                                    @endif
                                </td>
