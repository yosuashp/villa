                            ...
                            @forelse($items as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('User')">
                                        ...
                                        @else
                                            <p class="font-weight-bold"> {{ $item->owner_id ? __('N/A')  : __($item->name) }}</p>
                                        @endif
                                    </td>
                                    <td data-label="@lang('Owner')">
                                        @if($item->owner_id)
                                        <a href="{{ route('admin.owners.detail', $item->owner_id)}}"> {{@$item->owner->fullname}}</a>
                                        @else
                                            <p class="font-weight-bold">@lang('N/A')</p>
                                        @endif
                                    </td>
