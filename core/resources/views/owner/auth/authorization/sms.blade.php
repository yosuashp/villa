...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{asset('assets/laramin/images/1.jpg')}}">
        <div class="form-wrapper">
            ...
            <form method="POST" action="{{ route('owner.verify.sms') }}"
                onsubmit="return submitUserForm();" class="cmn-form mt-30 account-form">
                @csrf
                <div class="form-group">
                    <p class="text-center">@lang('Your Mobile Number'): <strong>{{ auth()->guard('owner')->user()->mobile }}</strong></p>
                </div>
                ...
                <div class="form-group">
                    <p>@lang('If you don\'t get any code'), <a
                            href="{{ route('owner.send.verify.code') }}?type=phone"
